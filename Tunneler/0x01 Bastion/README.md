...
## Solution
```console
CDSkids@kali:~/Desktop$ssh tunneler@tunneler.threatsims.com -p 2222
The authenticity of host '[tunneler.threatsims.com]:2222 ([159.89.178.136]:2222)' can't be established.
ECDSA key fingerprint is SHA256:NOm8+vN3VvEpdHb9BHyhf6VruETeeAL/LmasSufqK/Q.
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
Warning: Permanently added '[tunneler.threatsims.com]:2222,[159.89.178.136]:2222' (ECDSA) to the list of known hosts.
...
Last login: Wed Mar 23 20:05:09 2022 from 99.228.83.224
